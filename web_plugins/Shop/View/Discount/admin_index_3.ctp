        ...
        <div class="nw-table-content pd">
            ...
            <table>
                <thead><tr>
                	...
                	<th style="width: 100px; text-align: right;"><?php ___e('Orders amount')?></th>
                ...
                <?php foreach ($items as $item):?>
                	<tr>
                		...
                		<td style="text-align: center;">
                            <?php echo $this->Html->link(___('', true), array('action' => 'edit_3', $item[$ws_model]['id']), array('class' => 'ico ico_edit', 'title' => ___('Edit', true))); ?>
...
<div class="grid_4">
    <div class="nw-table">
        <?php echo $this->Form->create('ModDiscount', array('type' => 'file', 'class' => 'ajx_validate', 'url' => array('action' => 'edit_3')));?>
