                ...
                <?php foreach($items as $item):?>
                    <li id="tree_<?php e($item[$ws_model]['id'])?>" tree_parent_id="<?php e($item[$ws_model]['parent_id'])?>" class="mjs-nestedSortable-no-<?php e($item[$ws_model]['extra_1'] == '1' ? 'thisnesting' : 'nesting')?>">
                        <div class="cl <?php e($item[$ws_model]['extra_1'] == '1' ? 'cl_head' : null)?>">
                            ...
                            <span class="<?php e($item[$ws_model]['extra_1'] == '1' ? 'disregion ico_slider' : 'dismove')?> fl"></span>
                            <span class="fl"><?php et($item[$ws_model]['title'], 120)?> <?php if($item[$ws_model]['extra_1'] == '1') ws_e_code($item[$ws_model]['code'])?></span>
                            ...
                            <span class="disblock"><?php echo $this->Html->link('', array('action' => ($item[$ws_model]['extra_1'] == '1' ? 'edit_slider' : 'edit'), $item['ObjItemTree']['id']), array('class' => 'ico ico_edit', 'title' => ___('Edit'))); ?></span>
