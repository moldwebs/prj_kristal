            ...
            <div class="tabs-left">
                ...
                <div id="node-1">
                    <div class="n2 cl">
                        ...
                        <?php echo $this->Layout->__input('title', array('label' => ___('Sign'), 'class' => 'req'));?>
                    </div>
                    <div class="n4 cl">
                        <?php echo $this->Layout->__input('long_title', array('label' => ___('Title'), 'class' => 'req'));?>
                        ...
                        <?php echo $this->Form->input('autoupdate', array('label' => ___('Auto update'), 'options' => ws_yn()));?>
                    </div>
                </div>
            </div>
        </div>
