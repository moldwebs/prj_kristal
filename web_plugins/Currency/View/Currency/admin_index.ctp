        ...
        <div class="nw-table-content pd">
            ...
            <table>
                <thead><tr>
                    ...
                    <th style="width: 120px;"><?php echo $this->Paginator->sort('title', ___('Sign'));?></th>
                    <th style="width: 70px;"><?php ___e('Auto update')?></th>
                    <th style="width: 130px;"><?php ___e('Currency')?></th>
                    <th style="width: 130px;"><?php ___e('Value')?></th>
                    <th style="width: 130px;"><?php ___e('Default')?></th>
                ...
                <?php foreach ($items as $item):?>
                	<tr>
                		...
                		<td style="text-align: center;"><?php et($item[$ws_model]['title'], 60)?></td>
                        <td style="text-align: center;"><?php et($item[$ws_model]['autoupdate'], 60)?></td>
