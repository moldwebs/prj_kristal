        ...
        <div class="nw-table-content pd">
            ...
            <table>
                <thead><tr>
                    ...
                    <th style="width: 150px;"><?php echo $this->Paginator->sort('title', ___('Color'));?></th>
                ...
                <?php foreach ($items as $item):?>
                	<tr>
                        ...
                        <td style="text-align: center;">
                            <?php et($item[$ws_model]['data']['img_color'], 60)?>
                        </td>
                        <td style="text-align: center;">
                		...
                		<td style="text-align: center;">
                            <?php echo $this->element('/admin/item_actions', array('item' => $item, 'ws_model' => $ws_model, 'ws_act' => 'value_img_'))?>
                        </td>
                	</tr>
                <?php endforeach; ?>
                </tbody>
