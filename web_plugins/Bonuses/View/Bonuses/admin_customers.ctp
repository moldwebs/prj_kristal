        ...
        <div class="nw-table-content pd">
            ...
            <table>
                <thead><tr>
                	...
                	<th style="width: 200px;"><?php echo ___('Bonuses');?></th>
                </tr></thead>
                <tbody>
                <?php foreach ($items as $item):?>
                	<tr>
                		...
                		<td style="text-align: center;">
                            <?php e(!empty($item[$ws_model]['bonus_active']) ? $item[$ws_model]['bonus_active'] : '0')?>
                            /
                            <?php e(!empty($item[$ws_model]['bonus_used']) ? $item[$ws_model]['bonus_used'] : '0')?>
                        </td>
                	</tr>
                <?php endforeach; ?>
                </tbody>
