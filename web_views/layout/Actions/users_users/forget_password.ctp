    ...
    <div class="col-md-6 col-sm-12">
        <div class="box-border">
            <ul>
                ...
                <li class="row">
                    <div class="col-sm-12">
                        <?php echo $this->Form->input('password', array('label' => ___('New Password'), 'autocomplete' => 'off', 'type' => 'password', 'class' => 'req input form-control', 'value' => '', 'required' => 'required', 'div' => false));?> 
                    </div>
                </li>
                <li class="row">&nbsp;</li>
                <li>
