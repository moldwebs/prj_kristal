            ...
            <table>
                ...
                <?php foreach ($items as $item):?>
                	<tr>
                        ...
                        <td style="text-align: center;">
                            <?php echo $this->Form->input('extra_3', array('label' => false, 'div' => false, 'ajx_change' => $this->Html->url(array('action' => 'order', $item[$ws_model]['id'])), 'type' => 'text', 'value' => $item[$ws_model]['extra_3']));?>
                        </td>
                		<td style="text-align: center;">
