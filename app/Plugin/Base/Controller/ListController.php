<?php
class ListController extends BaseAppController {
    ...
    public function beforeFilter() {
        ...
        CmsNav::remove('base.children.pages.buttons.create_menu');
        CmsNav::remove('base.children.pages.buttons.create_page');
        CmsNav::remove('base.children.pages.buttons.create');
        CmsNav::remove('base.children.pages.buttons.create_list');
        CmsNav::remove('base.children.pages.buttons.create_set');
	...
	public function admin_order($id = null, $order = null){
        $this->ObjItemTree->updateAll(array("ObjItemTree.extra_3" => sqls($order, true)), array("ObjItemTree.id" => $id));
        $this->Basic->back();
	}
}
